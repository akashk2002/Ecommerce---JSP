...
<div class="collapse navbar-collapse menu--shylock"
	...
	<ul class="nav navbar-nav menu__list">
		...
		<li class="active menu__item menu__item"><a class="menu__link"
			href="mens.jsp">Fashion Wear </a></li>
		...
		%>
		<li class="menu__item"><a class="menu__link"
			href="customer-login.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;Login</a></li>
		<%
			}
		%>
		<li class=" menu__item"><a class="menu__link" href="help.jsp">About US&nbsp;<span
