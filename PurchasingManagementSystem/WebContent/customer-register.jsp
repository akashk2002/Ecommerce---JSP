...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords"
	content="Purchasing Managemnent System" />
					...
					<div class="login">
						<div class="login-bottom">
							...
							<div class='alert alert-success' id='success'
								style="width: 680px;">Customer Register Successfully.</div>
							<%
								}
							...
							<form action="AddCustomer" method="post">
								<div class="sign-up">
									<h4>Your Name :</h4>
									<input type="text" placeholder="Your Name" pattern="[a-zA-Z0-9_-]{6,12}" autofocus  title="must be alphanumeric in 6-12 chars" required=""
										style="width: 680px;" name="name">
								</div>
								<div class="sign-up">
									<h4>Email :</h4>
									<input type="text" placeholder="Type here" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Must contain @ and .(eg: epskill@gmail.com)" required=""
										style="width: 680px;" name="email">
								</div>
								<div class="sign-up">
									<h4>Password :</h4>
									<input type="password" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="must have 8 characters,lowercase,uppercase and special characters" required=""
										style="width: 680px;" name="password">

								</div>
								<div class="sign-up">
									<h4>Phone :</h4>
									<input type="text" placeholder="Type here"  minlength="10" maxlength="10" title="Only Numericals are allowed" pattern="[0-9]+" required=""
								...
								<div class="sign-up">
									<h4>Pincode :</h4>
									<input type="text" placeholder="Pincode" minlength="6" maxlength="6" pattern="[0-9]+" title="Only Numericals are allowed" required=""
