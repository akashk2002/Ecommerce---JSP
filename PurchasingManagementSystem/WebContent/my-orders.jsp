...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords"
	content="Purchasing Management System" />
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr class="rem1">
						...
						<td class="invert"><img src=uploads/<%=totalProduct.getString(1)%>
							style="width: 150px; height: 100px;"><br><%=totalProduct.getString(10)%></td>
