		...
		<center>
			<table border="2" cellspacing="2" cellpadding="2" width="80%">
				...
				<tr>
					...
					<td colspan="4"><strong><center>Total Amount To Be Paid.:&nbsp;<font color="green"><%=totalBill %></font>
							</center></strong></td>
				</tr>
				</center>
			</table>
				...
				<div class="checkout-left">
					<div class="checkout-right-basket animated wow slideInRight"
						...
						<a href="index.jsp"><span
							class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Back To Shopping</a>
					</div>
			</center>
	</div>
	<script>
