...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords"
	content="Purchasing Mangement System" />
 ...
 %>
	...
	<div class="contact">
		<div class="container">
			...
			<p>
			<h4>A purchasing system is a process for buying products and services encompassing purchase from requisition and purchase order through product receipt and payment. Purchasing systems are a key component of effective inventory management in that they monitor existing stock and help companies determine what to buy, how much to buy and when to buy it. Purchasing systems may be based on economic order quantity models.</h4>
			</p>
			<br>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-user'>&nbsp;&nbsp;Purchasing Management System</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-envelope'>&nbsp;&nbsp;ep@gmail.com.</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-phone'>&nbsp;&nbsp;9999999999.</i>
				</h4>
			</div>
